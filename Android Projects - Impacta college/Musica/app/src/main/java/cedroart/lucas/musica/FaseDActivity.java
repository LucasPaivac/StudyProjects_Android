...
public class FaseDActivity extends AppCompatActivity {
    ...
    private MediaPlayer oijesus;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tela_fased);
        ...
        oijesus = MediaPlayer.create(getBaseContext(),R.raw.poijesus);
        ...
        btn_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent ir = new Intent(getBaseContext(), FaseEActivity.class);
                        startActivity(ir);
                    }
                },TEMPO);
    ...
    protected void respota() {
        ...
        btn_d.setTextColor(Color.parseColor("#FF189B2B"));
