...
public class FaseCActivity extends AppCompatActivity {
    ...
    private MediaPlayer soquero;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tela_fasec);
        ...
        soquero = MediaPlayer.create(getBaseContext(),R.raw.playback_so_quero_ver_voce);
        ...
        btn_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent ir = new Intent(getBaseContext(), FaseDActivity.class);
                        startActivity(ir);
                    }
                },TEMPO);
    ...
    protected void respota() {
        ...
        btn_b.setTextColor(Color.parseColor("#FF189B2B"));
