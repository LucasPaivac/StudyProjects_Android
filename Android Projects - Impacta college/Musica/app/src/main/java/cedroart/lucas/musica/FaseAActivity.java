...
public class FaseAActivity extends AppCompatActivity {
    ...
    private MediaPlayer lindoes;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tela_fasea);
        ...
        lindoes = MediaPlayer.create(getBaseContext(),R.raw.playback_lindo_es);
        ...
        btn_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent ir = new Intent(getBaseContext(), FaseBActivity.class);
                        startActivity(ir);
                    }
                },TEMPO);
