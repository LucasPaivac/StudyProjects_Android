...
public class FaseEActivity extends AppCompatActivity {
    ...
    private MediaPlayer queroser;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tela_fasee);
        ...
        queroser = MediaPlayer.create(getBaseContext(),R.raw.playback_quero_ser_como_crianca);
        ...
        btn_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent ir = new Intent(getBaseContext(), ResultadoActivity.class);
                        startActivity(ir);
                    }
                },TEMPO);
    ...
    protected void respota() {
        btn_a.setTextColor(Color.parseColor("#FF189B2B"));
        btn_b.setTextColor(Color.parseColor("#FFC90F0F"));
        btn_c.setTextColor(Color.parseColor("#FFC90F0F"));
